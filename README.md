...
### Advanced Features
- **Custom Shortcodes**: Extend markdown with special shortcodes like `:::stats:::` for additional functionality
...
server:
  ...
  # Only enable this in trusted environments like a homelab where HTTPS is not available.
